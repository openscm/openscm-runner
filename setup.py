...
REQUIREMENTS_CICEROSCMPY = [
    "ciceroscm @ git+https://github.com/ciceroOslo/ciceroscm.git"
]
REQUIREMENTS_FAIR = ["fair"]
REQUIREMENTS_MAGICC = ["pymagicc>=2.0.0,<3"]
REQUIREMENTS_MODELS = REQUIREMENTS_FAIR + REQUIREMENTS_MAGICC + REQUIREMENTS_CICEROSCMPY
